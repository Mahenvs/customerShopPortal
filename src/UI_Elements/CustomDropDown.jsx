  ...
  return (
    <div className="mb-3 ">
      <select
        ...
        className={`w-[25rem] leading-8 p-2 my-2 border-b-2 border-skin-base rounded text-xl focus:outline-none focus:border-skin-base  justify-end dark:text-darkGray dark:bg-darkWhite dark:text-darkText ${selectedValue == "Choose" ? "text-[slate-400] dark:text-darkGray dark:bg-darkWhite" : "text-gray-700 dark:text-darkGray dark:bg-darkWhite" }`}
      >
        {options?.map((item) => (
